...
f=codecs.open("AMI.csv","r",encoding="utf-8")
l = f.read().encode('utf-8').splitlines()
res=[]
for i in l:
...
for i in range(1,len(res)):
    ...
    # images
    for wd,imgN in zip(WordList[:15],res[i][105:120]):
        if imgN!='' :
...
for i in range(1,len(res)):
    ...
    for wd,imgN in zip(WordList[15:30],res[i][90:105]):
        if imgN!='' :
...
for i in dico1.items():
    print i
print "\n"
for i in dico2.items():
    print i
print "\n"
for i in dico3.items():
    print i

dico1 = { k : v for k,v in dico1.iteritems() if v[1][1]<6 and int(v[2][1])<6}
dico2 = { k : v for k,v in dico2.iteritems() if v[1][1]<6 and int(v[2][1])<6}
dico3 = { k : v for k,v in dico3.iteritems() if v[1][1]<6 and int(v[2][1])<6}
